...
public class Urls {
    ...
    Buyer
     */
    public static String BaseUrl = "http://gzd.cnt.mybluehost.me/recomendados/api/";
    public static String login = "login";
    public static String signup = "signup";
    public static String home = "buyer/home";
    public static String favourite = "buyer/favourite";
    public static String detail = "buyer/product/profile";
